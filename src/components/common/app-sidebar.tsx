          ...
          <SidebarMenuItem>
            <SidebarMenuButton size={"lg"} asChild>
              <div className="font-semibold">
                <div className="bg-teal-300 flex justify-center items-center p-2 rounded">
          ...
          <SidebarMenuItem>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <SidebarMenuButton size={"lg"} className="data-[state=open]:bg-sidebar-accent data-[state=open]:text-sidebar-foreground">
